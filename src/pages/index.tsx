  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Laptop Inventory Application - Your ultimate solution for efficient laptop management. Streamline, optimize, and simplify your inventory process."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxsYXB0b3B8ZW58MHx8fHwxNjk3MTAyNDEwfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Laptop Inventory Application - Your ultimate solution for efficient laptop management. Streamline, optimize, and simplify your inventory process.`}
            </Text>
            <Box
